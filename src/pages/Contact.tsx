      ...
      <main id="main-content" className="container-blog py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-3">Contact DailyNews100</h1>
              ...
              <CardContent>
                <form onSubmit={submit} className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2"><Label htmlFor="email">Your Email *</Label>
                  ...
                  <p className="text-xs text-muted-foreground">Your email is kept private and is only used by our editors to reply to you.</p>
                </form>
              </CardContent>
            </Card>
          </div>
