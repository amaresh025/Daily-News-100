      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <Link to="/" className="inline-block mb-4">
            <span className="text-3xl font-extrabold">DailyNews<span className="text-primary">100</span></span>
          </Link>
          ...
          <CardDescription>
            {mode === 'signup'
              ...
              : 'Sign in to manage DailyNews100 content.'}
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground text-center mt-4">
            Access is restricted to administrators only. Non-admin sign-ins will be rejected.
          </p>
        </CardContent>
      </Card>
    </div>
