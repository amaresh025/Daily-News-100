import { Facebook, Twitter, Send, Share2, Link as LinkIcon, Check } from 'lucide-react';
import { useState } from 'react';
import { useToast } from '@/hooks/use-toast';

// Proper WhatsApp glyph (lucide doesn't ship one)
...
export default function ShareButtons({ url, title }: { url: string; title: string }) {
  ...
  const items = [
    { label: 'WhatsApp', icon: WhatsAppIcon, href: `https://api.whatsapp.com/send?text=${t}%20${u}` },
